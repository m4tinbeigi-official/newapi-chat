...
- صفحه‌ی تنظیمات (چرخ‌دنده‌ی بالای صفحه)
- پشتیبان‌گیری/بازیابی کامل (export/import به JSON)
- خروجی هر گفتگو به Markdown
- تغییر نام گفتگو
- دکمه‌ی کپی برای پیام‌ها و بلوک‌های کد
- نشانگر آفلاین و مدیریت بهتر خطا/timeout
